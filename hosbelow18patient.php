              ...
              <div class="card mb-3">
                ...
                <?php if ($user_type=='Hospital'){?>
                  ...
                  ?>
                          ...
                          <td ><?php echo $c; ?></td>
                          <td>Prescription</td>
                          <td><a style="text-decoration:none;" href="hosprescriptionview.php?id=<?php echo $pre['prescription_id']; ?>"> <button type="button" class="btn btn-primary"> view </button></a></td>
