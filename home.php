    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <!-- Blog Post -->
          <div class="card mb-4" id="questionarea">
            <form method="post"> 
                <textarea class="questionbox" name="post_content" rows="4" placeholder=".................Write Someting........" required></textarea>
                  
            <div class="card-body">
              <input class="select" list="browsers" name="browser" placeholder="select category" required>
                  ...
                  <button class="ask btn btn-primary" name="post">Ask question</button>
                  ...
                  <?php
                    ...
                    // $category = str_replace("'","\'",$category);
                        if($user_type=="Patient"){
                            ...
                            mysqli_query($conn,"insert into post (content,category,date,p_nid,d_nid,time) values ('$post_content','$category',CURRENT_DATE,'$user_id','$user_id',CURRENT_TIME) ")or die(mysqli_error());
                        }    
                  ...
                  <?php
                    ...
                    // }else{
                    //     mysqli_query($conn,"insert into commentpost (p_nid,d_nid,post_id,content,date,time) values ('$user_id','$user_id','$post_id','$comment_content',CURRENT_DATE,CURRENT_TIME)") or die (mysqli_error());
                    // }
            ...
            <div class="postshow">
              ...
              ?>
                      ...
                      <?php if($person_row['occupation'] == "Doctor"){  
                        if($user_type == "Patient" && $my['occupation'] == "Doctor" && $user_id == $nid){ ?>    
                          ...
                          <?php }else{ ?> 
                            ...
                            <!--  -->
                            <?php //echo $user_type."Id=".$nid."user".$user_id; ?> 
                            <?php if($user_type == "Doctor" && $user_id != $nid) {?> 
                              <div class="profilename"><a style="text-decoration:none; float:right;" href="myprofile.php?id=<?php echo $nid; ?>"><?php echo $name; ?></a></div>
                            <?php }else{ ?>
                              <div class="profilename"><a style="text-decoration:none; float:right;" href="doctorprofile.php?id=<?php echo $nid; ?>"><?php echo $name; ?></a></div>
                            <?php } ?>
                          ...
                          <input type="hidden" name="id" value="<?php echo $id; ?>" >
                                        ...
                                        <div class="commentername">  
                                          ...
                                          <?php if($occupation == "Doctor"){ 
                                            if($user_type == "Patient" && $my['occupation'] == "Doctor" && $user_id == $comment_by){ ?> 
                                              <a href="myprofile.php?id=<?php echo $comment_by; ?>"><b><?php echo $c_name; ?></b></a>
                                            <?php }else{ ?> 
                                              <?php if($user_type == "Doctor" && $user_id != $comment_by) {?>
                                                <a href="myprofile.php?id=<?php echo $comment_row['p_nid']; ?>"><b><?php echo $c_name; ?></b></a>
                                              <?php }else{ ?>
                                                <a href="doctorprofile.php?id=<?php echo $comment_by; ?>"><b><?php echo $c_name; ?></b></a><font color="gray"><small>@doctor</small></font>
                                              <?php } ?>
                                            <?php } ?> 
                                          <?php }	else{ ?>
                                            <a href="myprofile.php?id=<?php echo $comment_row['p_nid']; ?>"><b><?php echo $c_name; ?></b></a>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                    <li>
                      <a href="mypost.php"><?php echo "My Post" ?></a>
                    </li>
                    <br>
                    <?php
                    $query = mysqli_query($conn,"SELECT post.category,count(*) as c FROM post group by post.category order by count(*) DESC");
                    while ($category_row=mysqli_fetch_array($query)){
                    ?>
                    <li>
                      <a href="categorypost.php?category=<?php echo $category_row['category'] ?>"><?php echo $category_row['category']."(".$category_row['c'].")" ?></a>
                    </li>
...
<footer class="kilimanjaro_area">
        ...
        <div class=" kilimanjaro_bottom_header_one section_padding_50 text-center">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p>© All Rights Reserved by <a href="#">Identity Based Healthcare -(with all love)<i class="fa fa-love"></i></a></p>
                    </div>
                </div>
            </div>
        </div>
